...
<body>
                ...
                <div class="tm-top-header-inner">
                    ...
                    <nav class="tm-nav">
                        <ul>
                            ...
                            <li><a href="{{ url('/today-special') }}" class="{{ Request::url() == url('/today-special') ? 'active' : '' }}">Today Special</a></li>
                            <li><a href="{{ url('/menu') }}" class="{{ Request::url() == url('/menu') ? 'active' : '' }}">Menu</a></li>
                            <li><a href="{{ url('/contact') }}" class="{{ Request::url() == url('/contact') ? 'active' : '' }}">Contact</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row margin-bottom-60">
                    ...
                    <div class="col-lg-5 col-md-5 tm-footer-div">
                        ...
                        <p class="margin-top-15">Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim.
    ...
    <script type="text/javascript" src="js/maps.js"></script> <!-- Bootstrap -->
